...
<td>1.23</td>
<td>May5, 2014</td>
<td><strong>2013-03. Require PIV Cards to be on the GSA Approved Products List (APL) Prior to Issuance and require annual PIV card testing.</strong></td>
</tr>
</tbody>
</table>
...
[4.8.5 Conduct Constituting Acceptance of Modified Certificate 28](#conduct-constituting-acceptance-of-modified-certificate)
...
[4.12.2 Session Key Encapsulation and Recovery Policy and Practices 33](#session-key-encapsulation-and-recovery-policy-and-practices)
...
[5.3.8 Documentation Supplied to Personnel 39](#documentation-supplied-to-personnel)
...
[6.1.1.2 Subscriber Key Pair Generation 49](#subscriber-key-pair-generation)
...
[6.2.2 Private Key (n out of m) Multi-Person Control 55](#private-key-n-out-of-m-multi-person-control)

[6.2.3 Private Key Escrow 55](#private-key-escrow)
...
[6.2.4.5 Backup of Device Private Keys 56](#backup-of-device-private-keys)

[6.2.4.6 Backup of Common PIV Content Signing Key 56](#backup-of-common-piv-content-signing-key)
...
[6.3 Other Aspects of Key Pair Management 57](#other-aspects-of-key-pair-management)
...
[6.5 Computer Security Controls 59](#computer-security-controls)

[6.5.1 Specific Computer Security Technical Requirements 59](#specific-computer-security-technical-requirements)
...
[6.6.2 Security Management Controls 61](#security-management-controls)

[6.6.3 Life Cycle Security Controls 61](#life-cycle-security-controls)

[6.7 Network Security Controls 61](#network-security-controls)
...
[7.3.1 Version Number(s) 64](#version-numbers-2)
...
[9.4.6 Disclosure Pursuant to Judicial or Administrative Process 68](#disclosure-pursuant-to-judicial-or-administrative-process)
...
[9.16.5 Force Majeure 73](#force-majeure)
