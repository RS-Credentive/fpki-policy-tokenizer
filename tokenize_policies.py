...
def get_sentences(input: str) -> list[str]:
    processed_text: stanza.Document = nlp(str)
    return [sentence.text for sentence in processed_text.sentences]
    ...
    for index, line in enumerate(policy_lines):
        ...
        # Process lines starting with links "[" separately
            ...
            if line_matches is not None:
                ...
                if matched_elements["text"] != "":
                    sentences = get_sentences(matched_elements["text"])
                ...
                processed_lines.extend(get_sentences(line))
        ...
        # if the line looks like a table
            ...
            for column in columns:
                sentences = get_sentences(column)
